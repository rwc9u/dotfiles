(custom-set-variables
 ...
 '(package-selected-packages
   '(go-mode dockerfile-mode docker-compose-mode projectile-rails groovy-mode js2-refactor powerline color-theme-sanityinc-solarized color-theme fill-column-indicator coffee-mode js2-mode magit)))
